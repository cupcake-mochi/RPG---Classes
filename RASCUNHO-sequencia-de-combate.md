...
Antes de atacar o alvo da sequência ativa, escolha uma das seis Conduções e pague **metade da maestria arredondada para cima + 1 PE**, inclusive se o ataque errar. Se acertar, cause o dano normal, conte mais uma condução acertada e renove o prazo da sequência, mesmo se o alvo resistir ao efeito adicional. Se errar, a sequência termina imediatamente, salvo se você usar **Persistência** a partir do nível 23. **Não há teto de conduções acertadas**: você pode continuar enquanto a sequência estiver ativa, tiver ataques e pagar o custo.

Ao declarar uma Condução diferente, encerre os efeitos sustentados da anterior, mesmo se o novo ataque errar. Conduções repetidas não acumulam o próprio benefício; movimentos já realizados não são desfeitos. O número de conduções acertadas continua contando para os requisitos das Conclusões enquanto a sequência durar.

| Condução | Efeito após acertar |
|---|---|
| **Mudar o Ângulo** | Você pode se deslocar até **3 m adicionais**, respeitando terreno e obstáculos, sem provocar ataque de oportunidade do alvo da sequência. Outros inimigos podem reagir normalmente. |
| **Pressionar a Guarda** | Receba **+1 no acerto dos seus ataques contra o alvo** até o fim do seu próximo turno. Não acumula consigo mesma. |
| **Proteger o Avanço** | Receba **+1 de Defesa contra ataques do alvo** até o fim do seu próximo turno, inclusive ao Bloquear. Pode somar ao bônus de **Postura Firme**, da Escola de Arma. |
| **Acompanhar o Movimento** | Até o fim do seu próximo turno, quando o alvo terminar um deslocamento voluntário, você pode se mover uma vez até **metade do seu deslocamento**, sem gastar Reação nem seu movimento normal. Esse movimento não provoca ataque de oportunidade daquele alvo. |
| **Explorar o Desequilíbrio** | Exige que o alvo já esteja **Derrubado ou Agarrado**. Até o fim do seu próximo turno, ele sofre **−1 no próximo TR Físico ou de Vigor exigido por uma Conclusão sua**. Em Conclusão Dupla, afeta apenas um TR elegível, cuja ordem você declara antes das rolagens. |
| **Fechar a Rota** | O alvo faz um **TR Físico**. Se falhar, não pode **se afastar voluntariamente de você até o fim do próximo turno dele**. Pode se aproximar; movimento forçado e teleporte continuam possíveis. Isso não reduz, por si só, o valor do deslocamento para satisfazer **Fixar o Alvo**. |
...
|---|---|---|
| **Ponto Fraco** | Corpo a corpo; nenhuma condução mínima | Apenas nesse ataque, a margem crítica aumenta em uma unidade: normalmente **19–20** em vez de 20. Não concede vantagem. |
| **Explorar a Cobertura** | Distância; nenhuma condução mínima; alvo com cobertura | Somente nesse ataque, trate cobertura **Boa como Parcial** ou **Parcial como nenhuma**. Cobertura Total ainda impede o ataque. |
| **Rasteira** | Corpo a corpo ou distância; **1 condução acertada** | Após o acerto, **TR Físico**. Na falha, você pode empurrar o alvo até **1,5 m** e deixá-lo **Derrubado**. O empurrão é opcional; ambos dependem da mesma falha. |
| **Desarme** | Corpo a corpo; **1 condução acertada**; alvo empunhando arma ou objeto | Após o acerto, **TR Físico**. Na falha, o objeto sai da empunhadura e cai em espaço escolhido por você a até **3 m do alvo**. |
| **Interromper a Resposta** | Distância; **1 condução acertada** | Após o acerto, **TR Físico**. Na falha, o alvo não pode usar **Reações até o começo do seu próximo turno**. Ainda pode Bloquear, pois Bloquear não usa Reação. |
...
|---|---|
| Lâmina Curta, Arremesso, Yumi, Balestra ou Arma de Fogo | **Ritmo:** +1 no próximo ataque com a categoria escolhida contra o alvo da sequência; consome mesmo se errar e expira se a sequência acabar antes. |
| Lâmina Longa, Manopla ou golpes desarmados | **Postura Firme:** +1 de Defesa até o começo do seu próximo turno, inclusive ao Bloquear. Não acumula consigo mesma; trocar de Condução não a encerra. |
...
Quando errar o ataque de uma Condução, após eventuais rerrolagens, você pode gastar um uso de Persistência para manter a sequência. O ataque permanece errado, o PE é gasto, nenhum efeito da Condução acontece, ela não conta como acertada e **não renova o prazo**. A tentativa ocupa a Condução daquele turno; efeitos encerrados ao trocar de Condução não retornam. Persistência não recupera uma sequência já expirada.

Você tem **metade da maestria arredondada para baixo + 1 usos por descanso curto ou longo**: dois usos nos níveis 23–25 e três nos níveis 26–30. Usar Persistência não exige ação nem PE adicional.

## Nível 30 — Conclusão Dupla

**Uma vez por cena**, ao Concluir uma sequência com **pelo menos duas conduções acertadas**, você pode escolher **duas Conclusões diferentes da mesma fonte** e aplicá-las pelo mesmo ataque ou feitiço. Pode ter conduzido mais vezes; isso não aumenta o número de Conclusões. As fontes são **corpo a corpo, distância e feitiço**, sem misturá-las na dupla. A fonte usada para preparar a sequência pode ser diferente da fonte da Conclusão. Concluir com feitiço exige a habilidade própria da Estocada.
