...
|---|---:|---:|
| Distância, sem Compasso (Batedor, Executor) | 5,07 | **1,09** |
| Distância, com Compasso (Estocada) | 5,07 | **4,57** |
...
| **Ancorar** | 2 conduções | Físico | deslocamento do alvo cai a zero até o fim do próximo turno dele | 0,72 |
